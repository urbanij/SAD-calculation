...
HD_PWD='C:/Users/fu/Dropbox/UNI/MASTER/1M/PSM/DIGITALE/VHDL_designs/Final-project/SAD/vivado/SAD/SAD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SAD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SAD.tcl -notrace
